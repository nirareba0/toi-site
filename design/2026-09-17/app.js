      ...
      <div class="layout-container">
        ...
        <section class="hero-section" aria-labelledby="main-heading">
          <div class="hero-grid">
            <!-- 左側: コピーと主操作 -->
            <div class="hero-lead">
              <p class="hero-eyebrow">MIACIS / みんなの問いコーナー</p><h1 id="main-heading" class="hero-title">なんでだろう、
って思ったら。</h1>
              <p class="hero-description">友だちのこと。自分のこと。まだ名前のない気持ち。
ひとこと置いて、いろいろな大人と考えてみよう。</p>
            ...
            <div class="hero-visual-card" aria-label="問いと返事の例">
              <span class="question-spark" aria-hidden="true">?</span><svg class="visual-quote-symbol" width="36" height="28" viewBox="0 0 36 28" fill="none" aria-hidden="true">
...
見つけるんだろう。</p>
        ...
        <section id="questions-section" class="questions-section" aria-labelledby="questions-list-title">
          <div class="section-header-wrap">
            ...
            <p class="section-desc">「それ、自分も思ってた」から、はじめよう。</p>
